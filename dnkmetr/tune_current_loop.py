...
На реальном стенде FakeMultimeter надо заменить реальными измерениями (см.
PLAN.md, итерация 2) — здесь только числовая модель ~800-Ом нагрузки для
проверки, что сам алгоритм регулирования устойчив, прежде чем выходить к
приборам.
"""
